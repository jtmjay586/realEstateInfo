...
def get_sido_info():
    ...
    #print(temp)
    listData = list(temp["regionList"])
    #listDicData = list(zip(['cortarNo', 'cortarName'], [temp["regionList"].cortarNo, temp["regionList"].cortarName]))
    #print(listData)
    #temp=list(pd.DataFrame(temp["regionList"])["cortarNo"])
    #temp = list(zip(pd.DataFrame(temp["regionList"])["cortarNo"], pd.DataFrame(temp["regionList"])["cortarName"]))
    return listData
...
def get_gungu_info(sido_code):
    ...
    listData = list(temp["regionList"])
    #print(listData)
    #emp=list(pd.DataFrame(temp['regionList'])["cortarNo"])
    return listData
